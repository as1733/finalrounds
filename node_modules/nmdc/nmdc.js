...
var nmdc_getmyinfo = function(o) {
	return "$ALL "+o.nick+" "+(o.desc.length ? (o.desc+" "):"")+
		"<"+o.tag+" V:"+o.clientVersion+",M:P,H:1/0/0,S:5>$ $10  $$"+o.share+"$|";
};
...
var nmdc_parsemyinfo = function(str) {
	...
	if (tpos !== -1) {
		var tagPart = ret.desc.substr(tpos+1).slice(0,-2);
		ret.tag           = tagPart.split("V:")[0];
		ret.clientVersion = tagPart.substr(ret.tag.length + 2);
